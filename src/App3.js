...
import { PermissionsAndroid, Linking,StyleSheet,View,Text,Platform } from 'react-native';
 ...
 const getLocation = () => {
  ...
  if (Platform.Version >= 33) {
    const response = await PermissionsAndroid.request(
      PermissionsAndroid.PERMISSIONS.ANDROID.POST_NOTIFICATIONS
    );
...
const updateforeground =()=>{
    ...
    const aa = ReactNativeForegroundService.add_task(() => startTrackingTest(), {
      delay: 100,
      onLoop: true,
      taskId: "task123",
