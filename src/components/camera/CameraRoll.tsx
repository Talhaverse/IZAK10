...
import { StyleSheet, Text, View, TouchableOpacity, Image, SafeAreaView, Animated, StatusBar,Dimensions } from 'react-native';
import Camera from './Camera';
import { CameraApi, CameraType, CaptureData } from './types';
...
const CameraRoll = ({ onBack,setImageVal,imageVal,saveImage,mmVal }) => {
  ...
  return (
    <View style={mmVal == 20 ? styles.screen : styles.screen_zero}>
      <StatusBar hidden />
